...
import { FaAws, FaDocker, FaGithub, FaPython, FaLinux, FaJava, FaNodeJs, FaReact, FaJenkins, FaGitAlt, FaMicrosoft, FaCode, FaHtml5, FaCss3 } from "react-icons/fa";
import { SiKubernetes, SiTerraform, SiAnsible, SiPrometheus, SiGrafana, SiArgo, SiHelm, SiNginx, SiRedis, SiPostgresql, SiMongodb, SiElasticsearch, SiRabbitmq, SiApachekafka, SiGooglecloud, SiGitlab, SiCircleci, SiDatadog, SiNewrelic, SiVault, SiConsul, SiLinux, SiJavascript, SiMysql} from "react-icons/si";
...
export default function Skills() {
  ...
  const skillCategories = {
    ...
    "Databases & Messaging": [
      ...
      { name: "Apache Kafka", icon: SiApachekafka, color: "text-blue-400", level: 80 },
      { name: "zookeeper", icon: SiApachekafka, color: "text-green-400", level: 85 },
    ],
    "Programming & Scripting": [
      { name: "C++", icon: FaCode, color: "text-blue-400", level: 85 },
      { name: "Python", icon: FaPython, color: "text-yellow-400", level: 90 },
      { name: "Bash", icon: SiLinux, color: "text-green-400", level: 95 },
      { name: "HTML", icon: FaHtml5, color: "text-orange-500", level: 90 },
      { name: "CSS", icon: FaCss3, color: "text-blue-500", level: 85 },
      { name:"javascript", icon: SiJavascript, color: "text-green-500", level: 80 },
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <p className="text-4xl font-bold text-purple-400 mb-2">Fresher</p>
            ...
            <div>
              <p className="text-4xl font-bold text-pink-400 mb-2">4+</p>
