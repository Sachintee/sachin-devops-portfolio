...
export default function Footer() {
  ...
  const socials = [
    { icon: FaGithub, href: "https://github.com/sachintee", label: "GitHub" },
    { icon: FaLinkedin, href: "https://linkedin.com/in/sachin-teenwal", label: "LinkedIn" },
    { icon: FaTwitter, href: "https://x.com/sachinteenwal", label: "Twitter" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <a href="mailto:sachinteenwal@gmail.com" className="flex items-center gap-2 text-gray-400 text-sm hover:text-purple-400 transition">
              <FaEnvelope className="text-blue-400" />
              sachinteenwal@gmail.com
            </a>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Sachin Teenwal. Made with <FaHeart className="inline text-red-500 mx-1" /> using Next.js
          </p>
