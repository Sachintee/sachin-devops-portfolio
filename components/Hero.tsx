      ...
      <div className="w-full h-full grid lg:grid-cols-2">
        ...
        <div className="flex items-center px-8 lg:px-16 xl:px-24 py-20 relative z-10">
          ...
          >
            ...
            >
              <div>
                <p className="text-4xl font-black bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-1">Fresher</p>
                <p className="text-xs text-gray-400 uppercase tracking-wider"></p>
              </div>
              <div>
                <p className="text-4xl font-black bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-1">150+</p>
                <p className="text-xs text-gray-400 uppercase tracking-wider">Deploys</p>
              </div>
              <div>
                <p className="text-4xl font-black bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-1">89.9%</p>
            ...
            >
              <motion.a whileHover={{ y: -5 }} href="https://github.com/sachintee" className="text-gray-400 hover:text-white text-2xl transition">
                <FaGithub />
              </motion.a>
              <motion.a whileHover={{ y: -5 }} href="https://linkedin.com/in/sachin-teenwal" className="text-gray-400 hover:text-white text-2xl transition">
                <FaLinkedin />
              </motion.a>
              <motion.a whileHover={{ y: -5 }} href="https://x.com/sachinteenwal" className="text-gray-400 hover:text-white text-2xl transition">
                <FaTwitter />
              </motion.a>
              <motion.a whileHover={{ y: -5 }} href="mailto:sachinteenwal@gmail.com" className="text-gray-400 hover:text-white text-2xl transition">
                <FaEnvelope />
              </motion.a>
            </motion.div>
          </motion.div>
              ...
              >
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <p className="text-white font-medium">Jhunjhunu, Rajasthan, India</p>
                  </div>
                  <div>
                    <p className="text-gray-500 text-xs mb-1 uppercase tracking-wider">Email</p>
                    <p className="text-white font-medium">sachinteenwal@gmail.com</p>
                  </div>
                  <div>
                    <p className="text-gray-500 text-xs mb-1 uppercase tracking-wider">Specialization</p>
                    <p className="text-white font-medium">Software developer & Devops intern </p>
                  </div>
