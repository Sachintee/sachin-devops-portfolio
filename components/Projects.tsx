...
import { SiKubernetes, SiTerraform, SiPython, SiJenkins, SiGithub } from "react-icons/si";

export default function Projects() {
  const featuredProject = {
    title: "Infrastructure-as-Code-Driven-CI-CD-Pipeline-with-Terraform-Terratest",
    description: "Designed and implemented a CI/CD pipeline using Terraform for infrastructure provisioning and Terratest for automated validation. Integrated DevSecOps practices with security checks and automated deployments using GitHub Actions.",
    tech: [
      { name: "AWS", icon: FaAws, color: "text-orange-400" },
      { name: "Github Actions", icon: SiGithub, color: "text-blue-500" },
      { name: "Terraform", icon: SiTerraform, color: "text-purple-500" },
      { name: "Docker", icon: FaDocker, color: "text-blue-400" },
],
    metrics: [
      { label: "IaC", value: "Modular" },
      { label: "Testing", value: "Terratest" },
      { label: "Security", value: "DevSecOps" },
    ],
    status: "Completed",
    github: "https://github.com/Sachintee/Infrastructure-as-Code-Driven-CI-CD-Pipeline-with-Terraform-Terratest",
    demo: "#",
  };

 const projects = [
    {
      title: "End-to-End CI/CD & GitOps Kubernetes Platform",
      description: "Built a complete CI/CD pipeline with GitHub Actions, Dockerized Flask application, and implemented GitOps deployment using ArgoCD with Kubernetes.",
      tech: [
      ...
      metrics: 
     { deployment: "Automated", approach: "GitOps" },
      status: "Completed",
      github: "https://github.com/Sachintee/End-to-End-CI-CD-GitOps-Kubernetes-Platform",
    demo: "#",
    },
    {
      title: "GitOps K8s Deployment",
      description:
        "Implemented declarative Kubernetes deployments using ArgoCD with automatic synchronization and version-controlled infrastructure.",
      tech: [
        { icon: SiKubernetes, color: "text-blue-500" },
        { icon: FaDocker, color: "text-blue-400" },
      ],
      metrics: { sync: "Auto", config: "Declarative" },
      status: "Completed",
    },
    {
      title: "Kubernetes Auto-Scaling Application",
      description:
        "Deployed containerized application on Kubernetes and configured Horizontal Pod Autoscaler based on CPU utilization with Metrics Server.",
      tech: [
        { icon: SiKubernetes, color: "text-blue-500" },
        { icon: FaDocker, color: "text-blue-400" },
      ],
      metrics: { scaling: "HPA", monitoring: "Metrics Server" },
      status: "Completed",
    },
     {
      title: "AI-powered Resume Screening and Ranking System",
      description:
        "Developed a system to analyze resumes using AI techniques and rank candidates based on job requirements and keyword matching.",
      tech: [
        { icon: SiPython, color: "text-yellow-400" },
      ],
      metrics: { analysis: "AI-based", output: "Ranked Results" },
      status: "Completed",
    },
  ];
    ...
    <section id="projects" className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">Infrastructure-as-Code-Driven-CI-CD-Pipeline-with-Terraform-Terratest</p>
        </motion.div>
        ...
        >
          <motion.a
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            href="https://github.com/Sachintee?tab=repositories"
